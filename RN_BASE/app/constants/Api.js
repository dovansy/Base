...
export const requestLogin = payload => {
  return handleResult(
    getAxios.post("api/Service/LoginApp", payload)
  );
};
...
export const requestUserInfor = (deviceID = "") => {
  return handleResult(
    getAxios.get(`api/Service/GetUserInfor?deviceID=${deviceID}`)
  );
};

export const requestProductCategory = (deviceID = "") => {
  return handleResult(
    getAxios.get(`api/Service/getListCategory?deviceID=${deviceID}`)
  );
};
